...
(function() {
    ...
    angular
         ...
         * diferencia de que value no se puede inyectar en un bloque config ni 
         * en un objeto de tipo provider, mientras que constant sí.
         * Por otro lado, ni constant ni value pueden acceder a servicios 
         * externos. Si necesitamos algo así, es mejor usar un 
        ...
        ej06Controller.$inject = ['configData', 'customerValue'];
    
    // Esta funcion es el controlador que asociamos a la vista del ej04
    function ej06Controller(configData, customerValue) {
        
        var vm = this;
        
        vm.customers = customerValue.customers;
