describe('httpBasedService', function () {
  ...
  beforeEach(function (){  
    ...
    // The underscore avoids that the function argument's name hides the variable with
    // the same name: check https://docs.angularjs.org/api/ngMock/function/angular.mock.inject
