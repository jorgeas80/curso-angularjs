...
(function() {
    ...
    function customerPvd() {
        ...
        this.$get = function() {
            ...
            // Añadimos campo booleano para probar filtro checkmark (ver abajo)
            var customers = [
                {id: 1, name: 'Jorge Arévalo', city: 'Madrid', 'fecha_alta': '2014-07-12', 'ultima_factura': 1550.5485363, validado: true}, 
                {id: 2, name: 'Elena Nieto del Bosque', city: 'Toledo', 'fecha_alta': '2010-01-23', 'ultima_factura': 1800.5435363, validado: true}, 
                {id: 3, name: 'Javier Ucto', city: 'Murcia', 'fecha_alta': '2015-12-02', 'ultima_factura': 2100.5435363, validado: false}, 
                {id: 4, name: 'Jose Villanas', city: 'Córdoba', 'fecha_alta': '2006-04-15', 'ultima_factura': 988.5435363, validado: false}, 
                {id: 5, name: 'Marta Burete', city: 'Gijón', 'fecha_alta': '2009-08-15', 'ultima_factura': 1250.5435363, validado: true}
            ];
    ...
    function ej11Controller($scope, configData, customer) {
    ...
    app.filter("dateFormat", function($log, $filter) {
    ...
    app.controller('ej11Controller', ej11Controller);
    ej11Controller.$inject = ['$scope', 'configData', 'customer'];
